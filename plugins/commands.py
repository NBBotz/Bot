...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('•Bᴜʏ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ : Rᴇᴍᴏᴠᴇ Aᴅs •', callback_data='paid')
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**Bhai Tumna Hamara Main Channel Join Nahi Kiya Isliya Tumha Ma Movies Nahi Da Sakta...\n\nMovies Lena Chataho To '🍿ᴊᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ🍿' Button Pe Click Karo Or Humara Main Channel Join Karlo, Uska Bad '🔄 Try Again' Button Pe Click Karo...\n\nUska Bad Tumko Movie Da Dunga 😁...**",
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('Oᴡɴᴇʀ', url="https://t.me/Bot0987654")
                            ],
                            [
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Oᴡɴᴇʀ", url="t.me/Bot0987654")
                         ],[ 
                            InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=user,text=f"<b>📁Fɪʟᴇ Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Fɪʟᴇ Sɪᴢᴇ ➠ : {get_size(files.file_size)}\n\n<i>📌Nᴏᴛᴇ :- This Message Is Deleted In 20 Minutes To Avoid Copyrights. Save The Link To Somewhere Else</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('📂 Dᴏᴡɴʟᴏᴀᴅ Nᴏᴡ 📂', url=g)
                    ], [
        ...
        for file in files:
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie Files/Videos Will Be Deleted In <b><u>10 Minutes</u> 🫥 <i></b>(Due To Copyright Issues)</i>.\n\n<b><i>Please Forward This ALL Files/Videos To Your Saved Messages And Start Download There</i></b>")
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, Tʜɪs Cᴏᴍᴍᴀɴᴅ Oɴʟʏ Wᴏʀᴋs Oɴ Gʀᴏᴜᴘs !\n\n<u>Fᴏʟʟᴏᴡ Tʜɪs Sᴛᴇᴘs Tᴏ Cᴏɴɴᴇᴄᴛ Sʜᴏʀᴛɴᴇʀ:</u>\n\n𝟷. Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Wɪᴛʜ Fᴜʟʟ Aᴅᴍɪɴ Rɪɢʜᴛs\n\n𝟸. Aғᴛᴇʀ Aᴅᴅɪɴɢ Iɴ Gʀᴏᴜᴘ , Sᴇᴛ Yᴏᴜʀ Sʜᴏʀᴛɴᴇʀ\n\nSᴇɴᴅ Tʜɪs Cᴏᴍᴍᴀɴᴅ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink upshrink.com b9e48f618b4ef4ebd929980655hghk3ie8f760a27\n\nTʜᴀᴛ's Iᴛ !!! Eɴɪᴏʏ Eᴀʀɴɪɴɢ Mᴏɴᴇʏ 💲\n\n[[[ Trusted Earning Site - https://upshrink.com]]]\n\nIғ Yᴏᴜ Hᴀᴠᴇ Aɴʏ Dᴏᴜʙᴛs , Fᴇᴇʟ Fʀᴇᴇ Tᴏ Asᴋ Mᴇ - @Bot0987654</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
